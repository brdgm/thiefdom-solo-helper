<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/361875/thiefdom" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Juma Al-JouJou, Simon Schmieder</dd>
        <dt>Artist</dt>
        <dd>Mihajlo Dimitrievski</dd>
        <dt>Publisher</dt>
        <dd><a href="https://karma-games.com/" target="_blank" rel="noopener">Karma Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/thiefdom-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/thiefdom-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/thiefdom-solo-helper</a></dd>
      </dl>
